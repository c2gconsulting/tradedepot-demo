...
(function() {
	...
	b.prototype = {
		...
		g : function(f, h) {
			this.a = h;
			this.b = [];
			for (var e = f.getElementsByTagName("a"),
			    i = /#([^?]+)/,
			    a,
			    b,
			    c = 0; c < e.length; c++) {
	...
	var k = [],
	    ...
	    f = function() {
		for (var d = document.getElementsByTagName("ul"),
		    c = 0,
		    e = d.length; c < e; c++)
...
$(document).ready(function() {
	...
	if (!user_name) {
		...
		/*
		 ...
		 set_settings(theme_settings, 'st_sb_toggled');

		 $("#chooseDistributor").hide();

		 //$("#dashboard").removeClass("hidden");
		 //$("#sales-orders").removeClass("hidden");
		 $("#ordering").removeClass("hidden");
		 //$("#payments").removeClass("hidden");
		 //$("#goods-issues").removeClass("hidden");
		 $("#profile").removeClass("hidden");
		 //$("#settings").removeClass("hidden");

		 } else if (user_name == "salesmanager") {

		 $("#chooseDistributor").show();
		 ...
		 } else if (user_name == "storemanager") {
