    ...
    var startChart1 = function() {
        ...
        nv.addGraph(function() {
            ...
            chart.xAxis//Chart x-axis settings
                .axisLabel('day (d)').tickFormat(d3.format(',r'));

            chart.yAxis//Chart y-axis settings
                .axisLabel('percentage (% * 100)').tickFormat(d3.format('.02f'));
        ...
        function sinAndCos() {
            ...
            return [{
                ...
                key : 'Cowbell' //key  - the name of the series.
            }, {
                values : supply,
                key : 'Loya'
            }, {
